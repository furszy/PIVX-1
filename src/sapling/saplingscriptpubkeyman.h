...
public:
    ...
    SaplingNoteData(libzcash::SaplingIncomingViewingKey& ivk) : ivk {ivk}, nullifier() { }
    SaplingNoteData(libzcash::SaplingIncomingViewingKey& ivk, uint256& n) : ivk {ivk}, nullifier(n) { }
     ...
     * this was SaplingNoteData was created. If not set, we always assume that the
