    ...
    window(mainWindow)
{
    ...
    ui->btnColdStaking->setProperty("name", "master");
    ui->btnColdStaking->setText("MASTER\r\nNODES");
    ...
    btns = {ui->btnDashboard, ui->btnSend, ui->btnReceive, ui->btnAddress, ui->btnPrivacy, ui->btnMaster, ui->btnColdStaking, ui->btnSettings};
