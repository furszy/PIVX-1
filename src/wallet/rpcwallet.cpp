...
CAmount getBalanceShieldedAddr(libzcash::PaymentAddress& filterAddress, int minDepth = 1, bool ignoreUnspendable=true) {
    CAmount balance = 0;
...
UniValue getshieldedbalance(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 3)
        throw std::runtime_error(
                ...
                "\nArguments:\n"
                "1. \"address\"      (string) The selected address. It must be a Sapling address.\n"
